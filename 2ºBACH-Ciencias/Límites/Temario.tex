    ...
    \section{Límites y continuidad}
        ...
        \begin{itemize}
            \item Definición de límite y propiedades
                ...
                El límite de una función describe el valor al que se aproximan los valores de la función cuando la variable se acerca a un punto, sin necesidad de que la función esté definida en dicho punto.
                ...
                Si los valores por la izquierda y por la derecha no coinciden, el límite no existe.
            ...
            \item Indeterminaciones
               ...
               % TODO \includegraphics[scale=0.9]{../img/Límites1.png}
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Inderminación $0 \cdot \infty$}
                    
                        Esta indeterminación aparece cuando un factor tiende a $0$ y el otro a $\infty$.
                        Para resolverla, se transforma el producto en un cociente:
                        \begin{itemize}
                            \item Pasando el factor que tiende a $\infty$ al denominador.
                            \item O bien pasando el factor que tiende a $0$ al denominador.
                        \end{itemize}

                        \medskip

                        Ejemplo:  $\lim_{x \to +\infty} x \cdot \dfrac{1}{x^2}$ $ = 0 \cdot \infty$.

                        Reescribimos el producto como cociente:
                        $\lim_{x \to +\infty} \dfrac{x}{x^2} = \lim_{x \to +\infty} \dfrac{1}{x} = 0$
                        

                        

                        Ejemplo: $\lim_{x \to 0^+} x \cdot \ln x$
                        
                        Sabemos que:
                        \[
                        x \to 0^+ \quad \text{y} \quad \ln x \to -\infty
                        \]

                        Reescribimos:
                        \[
                        x \cdot \ln x = \frac{\ln x}{\frac{1}{x}}
                        \]

                        Como $\frac{1}{x} \to +\infty$, aplicamos el caso $\dfrac{\infty}{\infty}$:
                        \[
                        \lim_{x \to 0^+} \frac{\ln x}{\frac{1}{x}} = \lim_{x \to 0^+} \frac{\frac{1}{x}}{-\frac{1}{x^2}} = \lim_{x \to 0^+} (-x) = 0
                        \]
                    \item \textbf{Inderminación $1^\infty$}
                    
                        Aparece cuando una potencia tiene:
                        \begin{itemize}
                            \item base que tiende a $1$,
                            \item exponente que tiende a $\infty$.
                        \end{itemize}

                        Para resolverla, se aplica el logaritmo y se transforma en un producto:
                        \[
                        \lim a(x)^{b(x)} = e^{\lim b(x)\ln a(x)}
                        \]
                        ...
                        Tenemos:
                        \[
                        1 + \frac{1}{x} \to 1 \quad \text{y} \quad x \to \infty
                        \]
                        Luego es una indeterminación del tipo $1^\infty$.

                        Aplicamos logaritmos:
                        \[
                        \lim_{x \to +\infty} \left(1 + \frac{1}{x}\right)^x
                        = e^{\lim_{x \to +\infty} x \ln\left(1 + \frac{1}{x}\right)}
                        \]
                        ...
                        \textbf{Observación:}
                        Este tipo de indeterminación aparece con frecuencia en límites relacionados con el número $e$.
                \end{itemize}
            ...
            \item Continuidad de una función
               ...
               % TODO  \includegraphics[scale=0.5]{../img/Límites2.png}
                ...
                \begin{itemize}
                    \item \textbf{Enunciado:}  
                        ...
                        Si $f(a)$ y $f(b)$ tienen signos opuestos, es decir,
                        \[
                        f(a)\cdot f(b) < 0,
                        \]
                        ...
                        Si una función continua toma valores positivos y negativos en los extremos de un intervalo, necesariamente debe cortar al eje $x$ en algún punto intermedio.

                        \medskip

                        \textbf{Aplicación práctica:}  
                        Este teorema se utiliza para:
                        \begin{itemize}
                            \item Demostrar la existencia de soluciones de ecuaciones.
                            \item Justificar que una ecuación tiene al menos una raíz en un intervalo.
                        \end{itemize}

                        \medskip

                        \textbf{Ejemplo:}  
                        Sea la función $f(x)=x^3-x-1$, que es continua en $\mathbb{R}$.  
                        \[
                        f(1)=-1 \quad \text{y} \quad f(2)=5
                        \]
                        Como $f(1)\cdot f(2)<0$, por el Teorema de Bolzano existe al menos un número $c \in (1,2)$ tal que:
                        \[
                        f(c)=0.
                        \]
                        ...
                        \textbf{Observaciones:}
                        \begin{itemize}
                            \item El teorema no indica cuántas raíces existen, solo garantiza la existencia de al menos una.
                            \item Es imprescindible que la función sea continua en todo el intervalo cerrado.
                        \end{itemize}
                \end{itemize}
                ...
                \begin{itemize}
                    \item \textbf{Enunciado:}  
                        Sea $f(x)$ una función continua en un intervalo cerrado y acotado $[a,b]$.  
                        Entonces:
                        \begin{itemize}
                            \item La función alcanza un valor máximo absoluto.
                            \item La función alcanza un valor mínimo absoluto.
                        \end{itemize}

                        Es decir, existen $x_M, x_m \in [a,b]$ tales que:
                        \[
                        f(x_m) \le f(x) \le f(x_M) \quad \text{para todo } x \in [a,b].
                        \]

                        \medskip

                        \textbf{Interpretación intuitiva:}  
                        Una función continua en un intervalo cerrado no puede ``escaparse'': necesariamente toma un valor más grande que todos los demás y un valor más pequeño que todos los demás.
                        ...
                        Este teorema se utiliza para:
                        \begin{itemize}
                            \item Determinar máximos y mínimos absolutos.
                            \item Resolver problemas de optimización.
                            \item Justificar que una función está acotada en un intervalo cerrado.
                        \end{itemize}

                        \medskip

                        \textbf{Ejemplo:}  
                        Sea $f(x)=x^2$ en el intervalo $[-2,1]$.  
                        \[
                        f(-2)=4, \quad f(1)=1
                        \]
                        El mínimo absoluto se alcanza en $x=0$, donde $f(0)=0$, y el máximo absoluto se alcanza en $x=-2$, donde $f(-2)=4$.

                        \medskip

                        \textbf{Observaciones:}
                        \begin{itemize}
                            \item Es imprescindible que el intervalo sea \textbf{cerrado y acotado}.
                            \item En intervalos abiertos o no acotados, el teorema no se cumple.
                        \end{itemize}

                        
                \end{itemize}

                \textbf{Relación entre ambos teoremas}

                        \begin{itemize}
                            \item El Teorema de Bolzano garantiza la existencia de ceros.
                            \item El Teorema de Weierstrass garantiza la existencia de extremos.
                            \item Ambos requieren continuidad y trabajan sobre intervalos cerrados.
                        \end{itemize}
