...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item (1 punto) Resuelve la ecuación de segundo grado incompleta 
            \[2x^2-50=0\]
        \item (2 puntos) La edad de un padre es cinco veces la del hijo. Si dentro de dos años la edad del padre será cuatro veces la del hijo, ¿cuál es la edad actual de cada uno? $\vspace{4cm}$ 
        \item (2 puntos) La suma de tres números consecutivos es 30. Hállalos. $\vspace{4cm}$ 
        \item (EXTRA) Un rectángulo mide 5 cm más de alto que de ancho,  y su área mide 150 $cm^2$. ¿Cuánto miden sus lados?
    \end{enumerate}
\end{document}