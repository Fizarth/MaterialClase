...
\begin{document}
    ...
    \begin{enumerate}
        ...
        (1 punto) Dos veces el cuadrado de un número es igual a 8  $\vspace{7cm}$ 

        \item Resuelve las ecuaciones:
        \begin{enumerate}
            \item (1 punto) \[\dfrac{x}{2}-\dfrac{2(x+2)}{7}=\dfrac{x-3}{4}\] $\vspace{5cm}$ 
            \item (1 puntos) \[(x+1)^2+(1-x)(x+2)=0\] $\vspace{5cm}$ 
            \item (1 punto) \[(2x+2)(2x-2)=(x+1)^2 +2(x+1)(x-1)\] $\vspace{5cm}$ 
            \item (1 punto) \[2x^2(x-7)(x+5)=0\] $\vspace{5cm}$ 
        \end{enumerate}
